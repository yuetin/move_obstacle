...
class ValueNetwork(object):
    ...
    def step(self, obs, depth):
        ...
        with tf.variable_scope(self.name):
            ...
            h1 = tf.layers.dense(obs, 128, tf.nn.leaky_relu, name='h1')
            h2 = tf.layers.dense(h1, 128, tf.nn.leaky_relu, name='h2')
            h3 = tf.layers.dense(h2, 128, tf.nn.leaky_relu, name='h3')
            h4 = tf.layers.dense(h3, 128, tf.nn.leaky_relu, name='h4')
            h5 = tf.layers.dense(h4, 128, tf.nn.leaky_relu, name='h5')
...
class QValueNetwork(object):
    ...
    def step(self, obs, action, depth, reuse):
        with tf.variable_scope(self.name, reuse=reuse):
            ...
            h1 = tf.layers.dense(input, 128, tf.nn.leaky_relu, name='h1')
            h2 = tf.layers.dense(h1, 128, tf.nn.leaky_relu, name='h2')
            h3 = tf.layers.dense(h2, 128, tf.nn.leaky_relu, name='h3')
            h4 = tf.layers.dense(h3, 128, tf.nn.leaky_relu, name='h4')
            h5 = tf.layers.dense(h4, 128, tf.nn.leaky_relu, name='h5')
